...
variable "azure-app-client-id" {
  description = "Insert your Azure APP ID"
  type = string
  default = "xxxxxxxxxxxxxxxxxxxx"
}
variable "azure-app-client-key"{
  description = "Insert your Azure APP Key Secret"
  type = string
  sensitive = true
  default = "xxxxxxxxxxxxxxxxxxxx"
}
variable "azure-app-tenant-id"{
  description = "Insert your Azure AD Tenant ID"
  type = string
  default = "xxxxxxxxxxxxxxxxxxxx"
}
